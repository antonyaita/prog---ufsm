/*Os computadores foram inventados para realizar cálculos rapidamente e
...
int main(){
    ...
    printf("Digite o maior numero que o computador pode representar: ");
    scanf("%d", &maxComp);

    printf("Digite o valor de a: ");
    scanf("%d", &a);

    printf("Digite a operacao (somente + ou *): ");
    scanf(" %c", &operacao);
    ...
    {
        printf("Voce nao digitou a operacao corretamente, tente novamente");
    }
