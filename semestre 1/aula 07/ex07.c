...
ou mais jogadores. Onde cada jogador escolhe um valor entre dois ou um; a
um comando (geralmente um dos competidores anuncia em voz alta "Dois
...
int main(){
    ...
    printf("digite o 2 ou 1 para A: ");
    scanf("%d", &A);

    printf("digite o 2 ou 1 para B: ");
    scanf("%d", &B);

    printf("digite o 2 ou 1 para C: ");
    scanf("%d", &C);
